...
const routes: Routes = [
  {path: '', redirectTo: '/workloads', pathMatch: 'full'},
  {
    ...
    children: [
      ...
      {
        path: 'appstore',
        loadChildren: () => import('appstore/module').then(m => m.AppStoreModule),
      },
      {
        path: 'device',
        loadChildren: () => import('device/module').then(m => m.DeviceModule),
      },
      {
        path: 'subproject1',
        loadChildren: () => import('subproject1/module').then(m => m.Subproject1Module),
      },
      {
        path: 'subproject2',
        loadChildren: () => import('subproject2/module').then(m => m.Subproject2Module),
      },
      {
        path: 'subproject3',
        loadChildren: () => import('subproject3/module').then(m => m.Subproject3Module),
      },
      {
        path: 'subproject4',
        loadChildren: () => import('subproject4/module').then(m => m.Subproject4Module),
      },
      {
        path: 'subproject5',
        loadChildren: () => import('subproject5/module').then(m => m.Subproject5Module),
      },
      {
        path: 'search',
