...
export const BREADCRUMBS: IBreadcrumbMessage = {
  ...
  [IBreadcrumbMessageKey.AppStore]: $localize`App Store`,
  [IBreadcrumbMessageKey.Device]: $localize`Device Maganer`,
  [IBreadcrumbMessageKey.Subproject1]: $localize`子計畫一：無人機自主佈建與數量最佳化`,
  [IBreadcrumbMessageKey.Subproject2]: $localize`子計畫二：B5G/6G 三維網路之無人機無線資源分配技術`,
  [IBreadcrumbMessageKey.Subproject3]: $localize`子計畫三：RL-Based Beam Allocation`,
  [IBreadcrumbMessageKey.Subproject4]: $localize`子計畫四：無人機通道估測與全雙工波束成型技術`,
  [IBreadcrumbMessageKey.Subproject5]: $localize`子計畫五：基於感知之快取與通訊聯合最佳化技術`,
};
